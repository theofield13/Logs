...
1. Copy the entire content into a new file called `ai-automation-roadmap-todo.md`.  
2. Open it in any markdown editor (Notion, Obsidian, Typora, GitHub, VS Code, etc.).  
3. Click the checkbox next to each day to mark it ✅ when finished.  
4. At the end of each month, complete the milestone checkbox before moving on.  

**Tools needed from Day 1**: Free n8n account (cloud or self-hosted), Postman (free), Notion (free), OpenAI/Anthropic API key (start with $5–10 credit).  

---

## Month 1: Build your first workflow in n8n (20 working days)
**Goal**: Master n8n + API basics. Build 1 personal automation.
...
### Week 3
- [ ] **Monday**: Read “How to Read API Documentation” (Postman blog). Study Stripe API docs as example (even if not using it).
...
- [ ] **Wednesday**: In Postman, make ONE successful API call to that tool (pull a list of items). Document the request/response.
...
- [ ] **Friday**: **Month 1 Milestone** — Build a 3–5 step personal workflow. Explain webhooks, JSON, status codes, and prompts in plain English. Review everything.

---

## Month 2: Embed AI into your workflows (20 working days)
**Goal**: 3–5 AI-powered workflows running automatically.
...
- [ ] **Thursday**: Build practice project #1: Google Form → LLM classification → Airtable (follow article instructions).
...
- [ ] **Thursday**: Study n8n Error Handling & Retry docs. Add error workflow + Slack notification to your email triage.
...
- [ ] **Friday**: **Month 2 Milestone** — Have 3–5 working AI workflows. Estimate costs accurately. Identify your first $300–$500 gig (lead qualification or email triage).

### Week 8 (Early Monetization push)
- [ ] **Monday**: Apply to 3–5 Upwork/Fiverr jobs (or post 1 workflow on X/LinkedIn). Record 1 Loom demo of your best workflow.
- [ ] **Tuesday**: Apply to 3–5 Upwork/Fiverr jobs (or post 1 workflow on X/LinkedIn). Record 1 Loom demo of your best workflow.
- [ ] **Wednesday**: Apply to 3–5 Upwork/Fiverr jobs (or post 1 workflow on X/LinkedIn). Record 1 Loom demo of your best workflow.
- [ ] **Thursday**: Apply to 3–5 Upwork/Fiverr jobs (or post 1 workflow on X/LinkedIn). Record 1 Loom demo of your best workflow.
- [ ] **Friday**: Apply to 3–5 Upwork/Fiverr jobs (or post 1 workflow on X/LinkedIn). Record 1 Loom demo of your best workflow.

---

## Month 3: Build 1–2 repeatable service workflows (20 working days)
**Goal**: 1–2 polished, sellable automations + first paying client (or pilot).

**Pick your 1–2 use cases** (choose now based on interest + Upwork demand):
- Use Case A: Lead Generation Automation (highest demand)
- Use Case B: AI-powered Cold Outreach
- (Others are optional — come back later)
...
### Week 12
- [ ] **Monday**: Launch on Upwork/Fiverr/Contra + n8n Template Marketplace. Deliver first gig or free pilot for case study.
- [ ] **Tuesday**: Launch on Upwork/Fiverr/Contra + n8n Template Marketplace. Deliver first gig or free pilot for case study.
- [ ] **Wednesday**: Launch on Upwork/Fiverr/Contra + n8n Template Marketplace. Deliver first gig or free pilot for case study.
- [ ] **Thursday**: Launch on Upwork/Fiverr/Contra + n8n Template Marketplace. Deliver first gig or free pilot for case study.
- [ ] **Friday**: **Month 3 Milestone** — 1–2 repeatable workflows + at least 1 paying client (or pilot).

---

## Month 4: Add AI agents to your toolbox (20 working days)
**Goal**: Know exactly when to use agents vs simple chains.
...
- [ ] **Friday**: **Month 4 Milestone** — Working n8n agent + clear decision framework for when to use agents.

---

## Month 5: Make your automations production-ready (20 working days)
**Goal**: Deploy, monitor, and hand off to non-technical clients.
...
- [ ] **Friday**: **Month 5 Milestone** — All workflows deployed, monitored, and ready to hand off.

---

## Month 6: Scale & become hireable (20+ working days)
**Goal**: Portfolio, advanced use cases, consistent income, hireable level.

### Week 21–24 (Daily focus — repeat this pattern)
- [ ] **Monday**: Build 1 new repeatable workflow (choose from remaining use cases in article) + post 1 workflow demo on X/LinkedIn every Friday.
- [ ] **Tuesday**: Build 1 new repeatable workflow (choose from remaining use cases in article) + post 1 workflow demo on X/LinkedIn every Friday.
- [ ] **Wednesday**: Build 1 new repeatable workflow (choose from remaining use cases in article) + post 1 workflow demo on X/LinkedIn every Friday.
- [ ] **Thursday**: Build 1 new repeatable workflow (choose from remaining use cases in article) + post 1 workflow demo on X/LinkedIn every Friday.
- [ ] **Friday**: Build 1 new repeatable workflow (choose from remaining use cases in article) + post 1 workflow demo on X/LinkedIn every Friday. Apply to 5 higher-rate gigs per week ($1k–$5k). Update portfolio Notion site.
...
- [ ] **Friday**: **Month 6 Milestone** — 5+ paid clients or equivalent income, full production-ready portfolio, ready to be hired as AI Automation Builder. 🎉

---

**Maintenance after Month 6**  
- [ ] Every Monday: 1 hour reviewing new n8n templates or AI updates.  
- [ ] Every Friday: Post 1 workflow or client win.

You now have a fully checkable, day-by-day plan.  
Open this file every workday, check off the box when you finish your 1 hour, and watch the progress build.  

You will finish the entire course in exactly 6 months and start earning in Month 2–3, exactly as the article promises.

Good luck — you’ve got this!  
(Bookmark this file and open it every workday.)